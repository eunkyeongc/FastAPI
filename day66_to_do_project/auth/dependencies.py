...
# 2026. 08. 13.
# to_do_ project
# day66_to_do_project\auth\dependencies.py
...
#           이 의존성을 통과했다는 것은 로그인이 확인되었다라는 의미이다.#
# ============================================================================================
...
def get_current_user_id(credentials: HTTPAuthorizationCredentials = Depends(bearer)) -> int:
    ...
    검증 실패(만료/위조/타입 불일치)는 decode_access_token내부에서 이미 HTTPExecption을 raise(강제 예외처리)하므로 여기서는 신결쓸 필요가 없다.
    """
